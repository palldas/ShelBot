package com.laksh.shelbot.subsystems;
...
public class Knee extends ServoSubsystem{
	
	
	public Knee(Pin pin, int homePos) {
        super(pin, false, "Leg", homePos, 0, 180);
	}
	
	public Knee(Pin pin, boolean isReversed, String name, int homePos) {
        super(pin, isReversed, name, homePos, 0, 180);
	}
	
	public Knee(Pin pin, boolean isReversed, String name, int homePos, int maxLimit, int minLimit) {
