...
package com.laksh.shelbot;

import com.laksh.shelbot.commands.HomeAll;
import com.laksh.shelbot.commands.WalkForward;
import com.laksh.shelbot.cv.FaceDetection;
import com.laksh.shelbot.subsystems.Body;
import com.laksh.shelbot.utils.Logger;
...
//  private Command autonomousCommand, operatorControl;
  ...
  public void robotInit() {
    ...
    Scheduler.getInstance().add(new WalkForward());
    // new FaceDetection().start();
//    Scheduler.getInstance().add(new ServoTest(Robot.body.getHips()));
//    Scheduler.getInstance().add(new TripodGait(10));
  }
